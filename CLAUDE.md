...
| POST | `wallet/link/` | WALLET_LINK | Link wallet to authenticated account |
...
pip install https://github.com/BloclabsHQ/auth-pack/releases/download/v0.5.0/blockauth-0.5.0-py3-none-any.whl
