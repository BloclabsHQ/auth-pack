...
class SecurityLevels:
    ...
    LOW = {
        ...
        "performance": {
            ...
            "recommended_for": ["Development environments", "Unit testing", "CI/CD pipelines", "Local development"],
    ...
    def recommend_level(cls, use_case: str, performance_requirements: dict = None) -> str:
        ...
        if any(
            ...
            for keyword in ["financial", "banking", "crypto", "wallet", "critical", "military"]
        ):
            return "CRITICAL"

        # High security systems
        if any(
            keyword in use_case_lower for keyword in ["enterprise", "healthcare", "government", "security", "sensitive"]
        ):
            return "HIGH"
