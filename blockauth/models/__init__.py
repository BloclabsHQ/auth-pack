# Import TOTP + Social models (they use app_label='blockauth' so no separate
# app is needed). Models are always imported for Django migration discovery.
from blockauth.models.wallet_login_nonce import WalletLoginNonce  # noqa: F401
from blockauth.social.models import SocialIdentity  # noqa: F401
