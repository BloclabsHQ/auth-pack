        ...
        if invalidated_count > 0:
            blockauth_logger.warning(
                ...
                sanitize_log_context(
                    {"identifier": identifier, "subject": subject, "invalidated_count": invalidated_count}
                ),
            )
...
def _invalidate_existing_otps(identifier: str, subject: str) -> int:
    ...
    try:
        ...
        active_otps = OTP.objects.filter(identifier=identifier, subject=subject, is_used=False)
        ...
        if count > 0:
            ...
            blockauth_logger.debug(
                ...
                sanitize_log_context({"identifier": identifier, "subject": subject, "invalidated_count": count}),
            )
        ...
        blockauth_logger.error(
            ...
            sanitize_log_context({"identifier": identifier, "subject": subject, "error": str(e)}),
        )
