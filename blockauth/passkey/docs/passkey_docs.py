        ...
        200: OpenApiResponse(
            ...
            response={
                ...
                'properties': {
                    ...
                    'timeout': {
                        'type': 'integer',
                        'description': 'Registration timeout in milliseconds'
                    },
                    'excludeCredentials': {
                        'type': 'array',
        ...
        400: OpenApiResponse(
            ...
            examples=[
                ...
                OpenApiExample(
                    "Passkey Not Enabled",
                    value={
                        'error_code': 'PASSKEY_NOT_ENABLED',
                        'message': 'Passkey module is not enabled'
                    },
                    status_codes=[400]
                )
            ]
    ...
    'request': {
        'application/json': {
            ...
            'properties': {
                'id': {
                    'type': 'string',
                    'description': 'Base64URL-encoded credential ID from authenticator'
                },
                'rawId': {
                    'type': 'string',
        ...
        200: OpenApiResponse(
            ...
            response={
                ...
                'properties': {
                    'challenge': {
                        'type': 'string',
                        'description': 'Base64URL-encoded cryptographic challenge to sign'
                    },
                    'timeout': {
                        'type': 'integer',
    ...
    'request': {
        'application/json': {
            ...
            'properties': {
                'id': {
                    'type': 'string',
                    'description': 'Base64URL-encoded credential ID used for authentication'
                },
                'rawId': {
                    'type': 'string',
                    'description': 'Base64URL-encoded raw credential ID'
                    ...
                    'credential': {
                        ...
                        'properties': {
                            'id': {
                                'type': 'string',
                                'format': 'uuid',
                                'description': 'UUID of credential used'
                            },
                            'name': {
                                'type': 'string',
                                'description': 'User-assigned credential name'
        ...
        400: OpenApiResponse(
            ...
            examples=[
                ...
                OpenApiExample(
                    ...
                    value={
                        'error_code': 'INVALID_ORIGIN',
                        'message': 'Origin not in allowed origins'
                    },
                    status_codes=[400]
                ),
                OpenApiExample(
        ...
        200: OpenApiResponse(
            ...
            response={
                ...
                'properties': {
                    ...
                    'created_at': {'type': 'string', 'format': 'date-time', 'description': 'When passkey was registered'},
                    'last_used_at': {'type': 'string', 'format': 'date-time', 'nullable': True, 'description': 'Last successful authentication'},
                    'authenticator_attachment': {'type': 'string', 'description': 'Type: platform or cross-platform'},
                    'transports': {'type': 'array', 'items': {'type': 'string'}, 'description': 'Communication methods'},
...
passkey_credential_update_docs = {
    ...
    'examples': [
        OpenApiExample(
            "Update Name",
            value={'name': 'iPhone Face ID'},
            request_only=True,
            description="Update credential name"
        )
    ],
    'responses': {
        200: OpenApiResponse(
...
passkey_credential_delete_docs = {
    ...
    'responses': {
        204: OpenApiResponse(
            description="Credential deleted successfully (no content)"
        ),
        401: OpenApiResponse(
            description="Not authenticated - JWT token required"
        ),
