    ...
    def verify_registration(
        ...
        try:
            ...
            credential = CredentialData(
                ...
                algorithm=verification.credential_device_type.value if hasattr(verification, 'credential_device_type') else -7,
                ...
                backup_state=verification.credential_backed_up if hasattr(verification, 'credential_backed_up') else False,
