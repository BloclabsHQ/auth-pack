...
from blockauth.schemas.examples.common import expired_otp, invalid_otp
...
email_change_empty_input = OpenApiExample(
    ...
    summary="Empty input",
    value={"new_email": ["This field is required."], "password": ["This field is required."]},
)
...
email_change_confirm_invalid_input = OpenApiExample(
    ...
    value={"identifier": ["Enter a valid email address."]},
)
...
email_change_confirm_invalid_new_email = OpenApiExample(
    ...
    value={"identifier": ["Can't use this email."]},
)
