...
unrecognized_user_id_field = OpenApiExample(
    ...
    value={
        "detail": "Token contained no recognizable user id field"
    }
)

unrecognized_user = OpenApiExample(
    name='unrecognized_user',
    summary='Unrecognized user',
    value={
