...
sign_up_identifier_already_in_use = OpenApiExample(
    ...
    value={"identifier": ["Unable to complete registration with the provided information."]},
)

"""signup resend otp examples"""
signup_resend_otp_empty_input = OpenApiExample(
    name="signup_resend_otp_empty_input", summary="Empty input", value={"identifier": ["This field is required."]}
)

signup_user_not_found = OpenApiExample(
    name="signup_user_not_found",
    summary="User not found",
    value={"identifier": ["the provided identifier is not acceptable."]},
)

signup_resend_otp_rate_limit = OpenApiExample(
    name="signup_resend_otp_rate_limit",
    summary="Rate limit exceeded",
    value={"detail": "Rate limit exceeded. Try again in 30 seconds."},
)
