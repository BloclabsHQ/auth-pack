...
class CustomOpenApiResponse(OpenApiResponse):
    def __init__(self, status, description=None, response=None, examples=None):
        ...
        super().__init__(
            description=resp.get("description"), response=resp.get("response"), examples=resp.get("examples")
        )
    ...
    def __factory(self, status_code, description=None, response=None, examples=None):
        if status_code == 200:
            return {
                ...
                "response": response or {"type": "object", "properties": {"message": {"type": "string"}}},
                "examples": examples,
            }
            ...
            return {
                ...
                "response": response or {"type": "object", "properties": {"detail": {"type": "string"}}},
                "examples": examples,
            }
