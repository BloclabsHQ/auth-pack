...
totp_setup_docs = {
    ...
    'examples': [
        OpenApiExample(
            ...
            value={},
            request_only=True,
            description="Setup TOTP with default issuer name"
        ),
        OpenApiExample(
            "Custom Issuer",
            ...
            examples=[
                OpenApiExample(
                    ...
                    value={
                        ...
                        'message': 'Failed to set up TOTP 2FA.'
                    },
                    status_codes=[400]
                ),
                OpenApiExample(
    ...
    'responses': {
        200: OpenApiResponse(
            ...
            examples=[
                OpenApiExample(
                    "Success",
                    value={'message': 'TOTP 2FA enabled successfully'},
                    status_codes=[200]
                )
            ]
        ),
        ...
        401: OpenApiResponse(
            ...
            examples=[
                ...
                OpenApiExample(
                    "Invalid Backup Code",
                    value={
                        'error': 'totp_invalid_backup_code',
    ...
    'request': {
        'application/json': {
            ...
            'properties': {
                ...
                'password': {
                    'type': 'string',
                    'description': 'User account password (alternative to TOTP code)'
                }
            }
        }
    },
    ...
    'responses': {
        200: OpenApiResponse(
            ...
            examples=[
                OpenApiExample(
                    "Success",
                    value={'message': 'TOTP 2FA disabled successfully'},
                    status_codes=[200]
                )
            ]
        ),
